...
def get_fresh_ipaddresses(how_many):
    if debug: return ['172.17.0.'+str(randint(2, 11))]   
            ...
            for ip_address in get_fresh_ipaddresses(NHOSTS):
                ...
                try:
                    ...
                    with open(sys.argv[0], "r") as current_file:
                        ...
                        # temp_file.write("ekta random line pore add korlei hobe")
                        temp_file.flush()
                    temp_file.close()
                    # os.system("sudo chmod 777 temp_file.py")
                    scpcon.put("temp_file.py")              
                    scpcon.close()
