...
def aes_encryption(plain_text, secret_key, text_chars, key_size):
...
# file2_path = "F:/4-1/CSE406/offline1/secret_key.txt"
plainText = read_text_files(file1_path)
# # -----------------encryption part ---------------------------------------------
# secretKey=''
def encryption(secretKey):
    text_chars=16
    key_size=128
    encrypted_BitVector_Matrix=aes_encryption(plainText, secretKey, text_chars, key_size)
